...
import os
import time
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QScrollArea, QLabel, QPushButton, QFileDialog
...
import pyautogui
import json
from patterns_and_responses import pares, stories, joke, fun_facts, myself, pares1, excuse, dont_know ,bad_words
import webbrowser
...
class CommandProcessorThread(QThread):
    ...
    "My primary goal is to assist and enhance the user experience by providing valuable information and engaging in meaningful conversations."
            ...
            elif 'created' in command or 'made you' in command:
               if 'who created you' in command:
                   text = command.replace('who created you', '').strip()
               elif 'who made you' in command:
                   text = command.replace('who made you', '').strip()
               else:
                   text = ''
                   engine.say("I was created by Gabriel.")
                   print("Gabriel is my creator.")
                   engine.runAndWait()

                   text = "Gabriel is my creator."
                   self.update_label_text(text)
                   time.sleep(2)
            ...
            elif 'languages' in command or 'languages' in command:                 
                   engine.say('I speak Portuguese, but I can translate something into English for you '
                    'if you want. Just say the command: "translate" followed by the text.')
                   print('I speak Portuguese, but I can translate something into English for you '
                    'if you want. Just say the command: "translate" followed by the text.')
                   self.update_label_text('I speak Portuguese, but I can translate something into English for you '
                    'if you want. Just say the command: "translate" followed by the text.')
                   engine.runAndWait()
                   time.sleep(2)
               ...
               if 'what is your purpose delta' in command:
            ...
            elif 'i am not good' in command or 'i am not doing good' in command or 'not good' in command or 'no good' in command:
                self.speak('I am sorry to hear that. I hope you feel better soon')
                self.update_label_text('I am sorry to hear that. I hope you feel better soon')
                time.sleep(2)    
            elif 'i am good' in command:
                self.speak('Great!!! It is nice to hear you like this')
                self.update_label_text('Great!!! It is nice to hear you like this')
                time.sleep(2)
            elif 'well' in command:
                self.speak('Great!!! It is nice to hear you like this')
                self.update_label_text('Great!!! It is nice to hear you like this')
                time.sleep(2)
            elif 'i am not graet' in command or 'not graet' in command:
                self.speak('I am sorry to hear that. I hope you feel better soon')
                self.update_label_text('I am sorry to hear that. I hope you feel better soon')
                time.sleep(2)    
            elif 'not bad' in command:
                self.speak('Great!!! It is nice to hear you like this')
                self.update_label_text('Great!!! It is nice to hear you like this')
                time.sleep(2)
            elif 'i am not okay' in command:
                self.speak('I am sorry to hear that. I hope you feel better soon')
                self.update_label_text('I am sorry to hear that. I hope you feel better soon')
                time.sleep(2)
                ...
                self.speak('I\'m glad to hear that you\'re happy!')
                self.update_label_text('I\'m glad to hear that you\'re happy!')
                time.sleep(2)
            elif 'excited' in command:
                self.speak('That sounds exciting!')
                self.update_label_text('That sounds exciting!')
                time.sleep(2)
            elif 'sad' in command:
                self.speak('I\'m sorry to hear that you\'re feeling sad. Is there anything I can do to cheer you up?')
                self.update_label_text('I\'m sorry to hear that you\'re feeling sad. Is there anything I can do to cheer you up?')
                time.sleep(2)
            elif 'angry' in command:
                self.speak('I understand you\'re angry. Let\'s try to stay calm and talk about it.')
                self.update_label_text('I understand you\'re angry. Let\'s try to stay calm and talk about it.')
                time.sleep(2)
            elif 'confused' in command:
                self.speak('It\'s okay to be confused sometimes. How can I assist you further?')
                self.update_label_text('It\'s okay to be confused sometimes. How can I assist you further?')
                time.sleep(2)     
            elif 'nervous' in command:
               self.speak("Don't worry, I'm here to help. What's making you feel nervous?")
               self.update_label_text("Don't worry, I'm here to help. What's making you feel nervous?")
               time.sleep(2)
            elif 'relaxed' in command:
               self.speak("I'm happy to hear that you're feeling relaxed!")
               self.update_label_text("I'm happy to hear that you're feeling relaxed!")
               time.sleep(2)
            elif 'surprised' in command:
               self.speak("What surprised you? I'm curious to know!")
               self.update_label_text("What surprised you? I'm curious to know!")
               time.sleep(2)
            elif 'bored' in command:
               self.speak("If you're bored, maybe we can find something interesting to do together.")
               self.update_label_text("If you're bored, maybe we can find something interesting to do together.")
               time.sleep(2)
            elif 'grateful' in command:
               self.speak("I'm grateful for your positive feedback. Thank you!")
               self.update_label_text("I'm grateful for your positive feedback. Thank you!")
               time.sleep(2)
            elif 'worried' in command:
               self.speak("I understand your concern. Let's discuss what's on your mind.")
               self.update_label_text("I understand your concern. Let's discuss what's on your mind.")
               time.sleep(2)
            elif 'tired' in command:
               self.speak("It's important to get enough rest when you're tired. Take a break if you can!")
               self.update_label_text("It's important to get enough rest when you're tired. Take a break if you can!")
               time.sleep(2)
            elif 'inquisitive' in command:
               self.speak("I like your curiosity! Feel free to ask me any questions you have.")
               self.update_label_text("I like your curiosity! Feel free to ask me any questions you have.")
               time.sleep(2)
            elif 'proud' in command:
               self.speak("I'm proud of your achievements! Keep up the good work!")
               self.update_label_text("I'm proud of your achievements! Keep up the good work!")
               time.sleep(2)
            elif 'upset' in command:
               self.speak("I see you're upset. I'm here to listen. What's bothering you?")
               self.update_label_text("I see you're upset. I'm here to listen. What's bothering you?")
               time.sleep(2)                                      
...
#listen function
    ...
    def handle_unknown_question(self, unknown_question):
        ...
        self.speak("I don't know what that means. Can you tell me to help improve my knowledge please! what does it mean?")
        self.update_label_text("I don't know what that means. Can you tell me to help improve my knowledge please! what does it mean?")
        print("I don't know what that means. Can you tell me to help improve my knowledge please! what does it mean?")
        user_response = self.listen_for_command()

        if user_response and any(keyword in user_response.lower() for keyword in dont_know):
            response_text = "That's okay. If you think of anything else, feel free to ask. However I will source for you on google."
            self.update_label_text(response_text)
            self.speak(response_text)
            print(response_text)
            self.google_source(unknown_question)
        else:
